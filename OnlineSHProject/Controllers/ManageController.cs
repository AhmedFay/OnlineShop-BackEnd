...
namespace OnlineSHProject.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult Edit()
        {
            ...
            model.FirstN = user.FirstN;
            model.LastN = user.LastN;
            model.Email = user.Email;

            //user.Notifications.Add(new Notification()
            //{
            //    Title = "Welcome",
            //    Content = "Welcome to our site " + user.FirstN,
            //    SenderName = "System",
            //    User = user
            //});
            //db.SaveChanges();
        ...
        public ActionResult Edit(ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                string username = User.Identity.Name;
                // Get the userprofile
                ApplicationUser user1 = db.Users.FirstOrDefault(u => u.UserName.Equals(username));

                // Update fields
                user1.FirstN = user.FirstN;
                user1.LastN = user.LastN;
        ...
        //[Authorize(Roles = " Admin,ShopOwner")]
        [HttpPost]
        public ActionResult SendNotification(NotificationVM vm)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult Notifications()
        {
            ...
            var ns = db.Notifications.Where(n => n.User.Id == id).ToList();
            ns.Reverse();
            return View(ns);
        }
