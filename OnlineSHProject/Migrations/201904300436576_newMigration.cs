namespace OnlineSHProject.Migrations
{
    ...
    public partial class newMigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        NumVote = c.Int(nullable: false),
                        SumVote = c.Int(nullable: false),
                        Company = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Votes", "products_Id", "dbo.Products");
            ...
            DropIndex("dbo.Votes", new[] { "products_Id" });
